...
const nameRules = [(v: string) => !!v || 'Informe o nome']
const emailRules = [
...
<template>
  <v-container class="fill-height" max-width="480">
    <v-card class="pa-6 mx-auto w-100" elevation="3">
      <v-card-title class="text-h5 mb-2">Criar conta</v-card-title>
      <v-form @submit.prevent="submit">
        ...
        <v-btn type="submit" color="primary" block size="large" :loading="loading">Cadastrar</v-btn>
      </v-form>
